...
import (
	...
	queries "identity-api/Application/query_handlers/get_likes_for_blog_post"
...
func (h *GetLikesForBlogPostController) Handle(c *gin.Context) {
	...
	query := queries.GetLikesForBlogPostQuery{
