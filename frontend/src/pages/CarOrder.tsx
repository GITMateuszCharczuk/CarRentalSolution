    ...
    <form onSubmit={handleSubmit} className="container mx-auto px-4">
      <div className="mt-5 grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-3xl border border-gray-900 bg-white p-6 shadow-lg">
          <h2 className="mb-6 text-2xl font-bold">Your personal information</h2>
        ...
        {/* Reservation Details */}
        <div className="rounded-3xl border border-gray-900 bg-white p-6 shadow-lg">
          <h2 className="mb-6 text-2xl font-bold">Your reservation</h2>
            ...
            <div>
              ...
              <div className="mt-1 flex items-center space-x-2">
                ...
                <input
                  ...
                  name="numOfDrivers"
                  min="1"
                  className="block w-20 rounded-xl border-gray-300 text-center shadow-sm focus:border-primary-500 focus:ring-primary-500"
              ...
              <p className="mt-1 text-sm text-gray-500">The additional driver surcharge is 200 USD.</p>
            </div>
          </div>
        </div>
        ...
        {/* Summary and Payment */}
        <div className="rounded-3xl border border-gray-900 bg-white p-6 shadow-lg">
          <h2 className="mb-6 text-2xl font-bold">Summary and payment</h2>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="mt-2 flex items-center space-x-4">
                ...
                />
                <span className="font-medium">{carOffer.car_offer.heading}</span>
              </div>
            </div>

            <div>
              <h3 className="text-lg font-medium">General Terms and Conditions</h3>
            ...
            <div className="rounded-xl bg-gray-50 p-4">
              <div className="flex items-center justify-between">
                <span className="text-xl font-bold">Rent price</span>
                <div className="text-right">
                  <span className="text-2xl font-bold">{calculateTotalPrice()} USD</span>
