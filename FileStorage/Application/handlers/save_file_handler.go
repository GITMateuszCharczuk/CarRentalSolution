...
func NewSaveFileHandler(cmd *commands.SaveFileCommand) *SaveFileHandler {
	return &SaveFileHandler{command: cmd}
}

func (h *SaveFileHandler) Handle(w http.ResponseWriter, r *http.Request) {
...
func (h *SaveFileHandler) Route() string {
	return "/files"
}
