...
type GetCarOffersRequest struct {
	...
	DateTimeFrom          string   `json:"dateTimeFrom" example:"2023-12-12T00:00:00Z" validate:"omitempty,datetime,futuredate" swaggertype:"string"`
	DateTimeTo            string   `json:"dateTimeTo" example:"2023-12-12T23:59:59Z" validate:"omitempty,datetime,gtdate=DateTimeFrom" swaggertype:"string"`
