...
import (
	...
	contract "rental-api/Application.contract/BlogPostLikes/GetLikesForBlogPost"
	queries "rental-api/Application/query_handlers/blog_post_like/get_likes_for_blog_post"
...
// @Router /rental-api/api/posts/{id}/likes [get]
