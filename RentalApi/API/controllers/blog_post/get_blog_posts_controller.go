...
import (
	...
	contract "rental-api/Application.contract/BlogPosts/GetBlogPosts"
	queries "rental-api/Application/query_handlers/blog_post/get_blog_posts"
...
// @Router /rental-api/api/posts [get]
