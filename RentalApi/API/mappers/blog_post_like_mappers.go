...
import (
	...
	delete_contract "rental-api/Application.contract/BlogPostLikes/DeleteLikeForBlogPost"
	get_contract "rental-api/Application.contract/BlogPostLikes/GetLikesForBlogPost"
	commands "rental-api/Application/command_handlers/blog_post_like/create_like_for_blog_post"
	delete_commands "rental-api/Application/command_handlers/blog_post_like/delete_like_for_blog_post"
	get_queries "rental-api/Application/query_handlers/blog_post_like/get_likes_for_blog_post"
)
