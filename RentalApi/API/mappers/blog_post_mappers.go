...
import (
	...
	create_contract "rental-api/Application.contract/BlogPosts/CreateBlogPost"
	delete_contract "rental-api/Application.contract/BlogPosts/DeleteBlogPost"
	get_blog_post_contract "rental-api/Application.contract/BlogPosts/GetBlogPost"
	get_blog_posts_contract "rental-api/Application.contract/BlogPosts/GetBlogPosts"
	update_contract "rental-api/Application.contract/BlogPosts/UpdateBlogPost"
	commands "rental-api/Application/command_handlers/blog_post/create_blog_post"
	delete_commands "rental-api/Application/command_handlers/blog_post/delete_blog_post"
	update_commands "rental-api/Application/command_handlers/blog_post/update_blog_post"
	get_blog_post_queries "rental-api/Application/query_handlers/blog_post/get_blog_post"
	get_blog_posts_queries "rental-api/Application/query_handlers/blog_post/get_blog_posts"
)
